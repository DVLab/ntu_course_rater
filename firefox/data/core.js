...
var Chart = Highcharts.Chart,
	...
	extend(defaultOptions.lang, {
		...
		downloadPDF: '下載為PDF文件',
		downloadSVG: '下載為SVG向量圖',
		exportButtonTitle: '下載',
		printButtonTitle: '列印'
	});
...
extend(Chart.prototype, {
	...
	getSVG: function (additionalOptions) {
		...
		options.chart.backgroundColor = 'white'; // always white backgroud: added by Gary
		options.legend.itemStyle = {color: 'black',fontWeight: 'bold'};
		options.title.style = { color: 'black', font: 'bold 16px "Trebuchet MS", Verdana, sans-serif'};
		options.plotOptions.pie.dataLabels.color = 'black';
		options.plotOptions.pie.dataLabels.connectorColor = 'black';
		...
		svg = svg.replace(/fill:white/g,'fill:black').replace(/stroke=\"white\"/g,'stroke=\"black\"'); //added by Gary, forcely modify the color...
...
})(jQuery);/*! tableSorter 2.4+ widgets - updated 1/29/2013
 *
 * Column Styles
 * Column Filters
 * Column Resizing
